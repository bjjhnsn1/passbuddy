            ...
            <div className="mb-6 bg-gray-50 rounded-xl p-5">
              ...
              <div className="flex flex-col sm:flex-row gap-2 justify-center">
                <a
                  ...
                  onClick={() => trackEvent("app_store_click", { location: "score_screen", store: "ios", score: score, total: total })}
                ...
                {playStoreUrl && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    onClick={() => trackEvent("app_store_click", { location: "score_screen", store: "android", score: score, total: total })}
                    className="inline-flex items-center justify-center gap-2 bg-black text-white px-5 py-2.5 rounded-xl text-sm font-medium hover:bg-gray-800 transition-colors"
                  >
                    <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
                      <path d="M3.609 1.814L13.792 12 3.61 22.186a.996.996 0 0 1-.61-.92V2.734a1 1 0 0 1 .609-.92zm10.89 10.893l2.302 2.302-10.937 6.333 8.635-8.635zm3.199-3.199l2.302 2.302a1 1 0 0 1 0 1.38l-2.302 2.302L15.396 13l2.302-2.492zM5.864 2.658L16.8 8.99l-2.302 2.303-8.635-8.635z"/>
                    </svg>
